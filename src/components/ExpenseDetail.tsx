...
export default function ExpenseDetail({ expense }: ExpenseDetailProps) {
    ...
    return (
        <SwipeableList>
            <SwipeableListItem maxSwipe={1} /* cuantos pixeles quiero que se muevan*/leadingActions={leadingActions()} trailingActions={trailingActions()}>
                <div className="flex gap-5 items-center bg-white shadow-lg w-full p-5 border-b border-gray-200">
                    <div>
