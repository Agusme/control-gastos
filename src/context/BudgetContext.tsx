...
export const BudgetProvider = ({ children }: BudgetProviderProps) => {
   ...
   /* total gastado */ const totalExpenses = useMemo(() => state.expenses.reduce((total, expense) => expense.amount + total, 0), [state.expenses])
    /* cuanto queda del presupuesto */ const remainingBudget = state.budget - totalExpenses
